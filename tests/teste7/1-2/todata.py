...
genetics = ['-100-1-999999-50-', '-100-1-999999-100-', '-100-1-999999-200-', '-100-1-999999-500-', '-100-1-999999-1000-']
hill = ['-hill-100-1-']
tabu = ['-tabu-100-1-']
...
def prettyname(string):
	...
	if '-100-1-999999-500-' in string: return 'G_p500'
	if '-100-1-999999-1000-' in string: return 'G_p1000'
